...
- Non-commercial academic inspection.
- Reproduction and validation of the working paper's reported experiments.
- Non-commercial research extensions with proper attribution.

Not permitted without written permission from the author(s):

- Commercial deployment.
- Use in live trading, investment decision-making, production risk systems, or client-facing pricing systems.
- Redistribution as a standalone model product.

## Attribution

If you use this repository, cite the working paper and the repository. The repository citation metadata is provided in `CITATION.cff`.
...
All paper materials, figures, tables, generated outputs, and trained model artifacts are provided for research and educational use only. They are provided without warranty of any kind, express or implied. The author(s) are not liable for any claim, damages, or other liability arising from use of these materials.
